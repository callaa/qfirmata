...
#ifndef QML_FIRMATA_PLUGIN_H
#define QML_FIRMATA_PLUGIN_H

#include <QQmlExtensionPlugin>

class QmlFirmataPlugin : public QQmlExtensionPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QQmlExtensionInterface")

public:
	QmlFirmataPlugin(QObject *parent=nullptr) : QQmlExtensionPlugin(parent) { }
